...
*   [🛠️ Local Setup Instructions](#️-local-setup-instructions)
    ...
    *   [3. Navigate to the Folder](#3-navigate-to-the-folder)
    *   [4. Setup API Keys](#4-setup-api-keys)
    *   [5. Launch the Application](#5-launch-the-application)
*   [🐳 Docker Setup (Optional)](#-docker-setup-optional)
    *   [☁️ Deploying Docker to the Cloud](#️-deploying-docker-to-the-cloud)
*   [☁️ Cloud Deployment (Firebase)](#️-cloud-deployment-firebase)
*   [📄 License](#-license)
